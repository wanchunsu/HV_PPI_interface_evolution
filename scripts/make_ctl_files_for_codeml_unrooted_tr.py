...
def make_copies_of_ctl_fi(ex_ctl_fi, residue_type, binned_dnds_folder, tree_fi):
    ...
    """
    seqfi = osp.join(residue_type + '.binned_codons.fasta')
    modified_ctl_fi = osp.join(binned_dnds_folder, residue_type + '.codeml_unrooted.ctl')
    #modified_ctl_fi = osp.join(binned_dnds_folder, residue_type + '.codeml.ctl')

    codeml_outfi = residue_type + '.codeml_unrooted.out' #osp.join(modified_ctl_fi_folder, residue_type + '.codeml.out')
