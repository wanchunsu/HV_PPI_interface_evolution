...
path_to_uniprot_fasta="../data/IntAct_human_human/fasta_files"
...
blastp -db ../data/PDB/pdb_seqres_db -query $human_uniprot_fa -outfmt 6 -out "$results_dir/human_endo_prots_against_pdb.blast_out.txt"
