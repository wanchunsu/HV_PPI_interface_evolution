...
Relabel species tree nodes with corresponding protein IDs in MSAs
=================================================================
...
def main():
	...
	msa_fasta_fi = args.msa_file #e.g. A0A075B6I9_msa.fasta
	species_tree_file_name = args.species_tree_fi #e.g. taxnames_19_orthologs.nwk
	output_folder_id = args.output_id # e.g. output_folder_id=19_orthologs
	ortholog_folder_label = args.ortholog_folder
	
	msa = osp.join(script_dir, '..', 'data', 'homologs_and_conservation', ortholog_folder_label, folder_name, 'MSA_'+ output_folder_id, msa_fasta_fi) #e.g. ../data/homologs_and_conservation/orthologs/v_target_h/MSA_19_orthologs/A0A075B6I9_msa.fasta

	relabeled_species_tree_folder = osp.join(script_dir, '..', 'data', 'homologs_and_conservation', ortholog_folder_label, folder_name, 'relabeled_species_trees_' + output_folder_id)

	species_tree_file = osp.join(script_dir, '..', 'data', 'homologs_and_conservation', ortholog_folder_label, species_tree_file_name)
